                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="number" name="commission_fee" class="form-control @error('commission_fee') is-invalid @enderror" id="commission_fee" placeholder="Commission Fee" min=0 value="{{ $vendor->commission_fee }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="bootstrap-timepicker">
                                            ...
                                            <label for="opening_time" class="col-sm-4 col-form-label"> Opening Time <span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="text" class="form-control datetimepicker-input @error('opening_time') is-invalid @enderror" data-target="#opening_time" name="opening_time" value="{{ $vendor->opening_time }}" onkeydown="return false" autocomplete="off"/>
                                        ...
                                        <div class="bootstrap-timepicker" readonly>
                                            ...
                                            <label for="closing_time" class="col-sm-4 col-form-label"> Closing Time <span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="text" class="form-control datetimepicker-input @error('closing_time') is-invalid @enderror" data-target="#closing_time" name="closing_time" readonly value="{{ $vendor->closing_time }}" onkeydown="return false" autocomplete="off"/>
                                        ...
                                        <div class="bootstrap-timepicker" readonly>
                                            <div class="form-group row">
                                            <label for="order_closing_time" class="col-sm-4 col-form-label"> Closing Time <span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <div class="input-group date" id="order_closing_time" data-target-input="nearest" >
                                                    <input type="text" class="form-control datetimepicker-input @error('order_closing_time') is-invalid @enderror" data-target="#order_closing_time" name="order_closing_time" value="{{ $vendor->order_closing_time }}" onkeydown="return false" autocomplete="off"/>
