@extends('layouts.master', ['activePage' => 'item', 'titlePage' => __('Update Item')])
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        {!! Form::open(['route' => ['items.update', $item->id],'files' => true, 'enctype' => 'multipart/form-data', 'class'=>'form-horizontal','method' => 'PATCH']) !!}
                        <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Name" value="{{ $item->name }}">
                                                @error('name')
                                                    <span id="exampleInputEmail1-error" class="error invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                            <input type="mm_name" class="form-control @error('mm_name') is-invalid @enderror" id="mm_name" name="mm_name" placeholder="Myanmar Name" value="{{ $item->mm_name }}">
                                                @error('mm_name')
                                                    <span id="exampleInputEmail1-error" class="error invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                ...
                                                <div class="select2-purple">
                                                    <select class="form-control @error('sub_category_id') is-invalid @enderror select2 sub_category_id" name="sub_category_id" data-placeholder="Select Sub Category" data-dropdown-css-class="" style="width: 100%;" id="sub_category_id" data-attr-url="{{url('admin/brands/getDataBySubCategoryID')}}">
                                                        ...
                                                        @foreach ($sub_categories as $sub_cat)
                                                            <option value="{{ $sub_cat->id }}" {{ ($item->sub_category_id==$sub_cat->id)?"selected":"" }}>{{$sub_cat->name}}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="bar_code" class="form-control @error('bar_code') is-invalid @enderror" id="bar_code" placeholder="Bar Code" value="{{$item->bar_code}}" >
                                                @error('bar_code')
                                                    <span id="exampleInputEmail1-error" class="error invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" id="price" placeholder="Price" min=0 value="{{$item->price}}">
                                                @error('price')
                                                    <span id="exampleInputEmail1-error" class="error invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                ...
                                                <div class="select2-purple">
                                                    <select class="item_type form-control @error('item_type') is-invalid @enderror select2" name="item_type" data-placeholder="Select Item Type" data-dropdown-css-class="" style="width: 100%;">
                                                        ...
                                                        @foreach ($item_types as $item_type)
                                                            <option value="{{ $item_type->key }}" {{ ($item->item_type==$item_type->key)?"selected":"" }}>{{$item_type->value}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('item_type')
                                                        <span id="exampleInputEmail1-error" class="error invalid-feedback">{{ $message }}</span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="description" id="" class="form-control @error('description') is-invalid @enderror">{{$item->description}}</textarea>
                                                @error('description')
                                                    <span id="exampleInputEmail1-error" class="error invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
